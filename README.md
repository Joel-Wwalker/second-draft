...
[![Tests](https://img.shields.io/badge/tests-232%20unit%20%2B%202%20e2e-brightgreen)](tests)
...
232 unit tests and 2 Playwright tests that drive the built extension in a real
